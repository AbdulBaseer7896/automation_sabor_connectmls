...
<body>
    ...
    <div class="container">
        ...
        <div class="section">
            <p><strong>1. PARTIES:</strong> The parties to this contract are <span class="text-input user_input">SECRETARY OF VETERANS AFFAIRS</span> (Seller)
                and <span class="text-input user_input">Silverkey investments LLC or Designated entity</span> (Buyer).
                Seller agrees to sell and convey to Buyer and Buyer agrees to buy from Seller the Property defined below.</p>
        </div>

        <div class="section">
            <p><strong>2. PROPERTY:</strong> The land, improvements and accessories are collectively referred to as the Property.</p>
            <div class="subsection">
                <span>A.</span>
                <div class="sub_subsection">
                    LAND: Lot <span class="text-input user_input">36</span>, Block <span class="text-input user_input">1</span><br>
                    <span class="text-input user_input">HEIGHTS OF WESTCREEK PH 1</span> Addition, City of <span class="text-input user_input">San Antonio</span><br>
                    County of <span class="text-input user_input">Bexar</span>, Texas, known as <span class="text-input user_input">1208 CREEK KNL TX 78253</span>
            ...
            <div class="subsection">
                <span>D.</span>
                <div class="sub_subsection">
                    EXCLUSIONS: The following improvements and accessories will be retained by Seller and must be removed prior to delivery of possession: <span class="text-input user_input"> N/A </span>
                </div>
            </div>
            <div class="subsection">
                <span>E.</span>
        ...
        <div class="section">
            ...
            <div class="subsection">
                <span>B.</span>
                <div class="sub_subsection">
                    Sum of all financing described in the attached: ☒ Third Party Financing Addendum, ☐ Loan Assumption Addendum,☐ Seller Financing Addendum .................$ <span class="text-input user_input">135,000.00</span>
                </div>
            </div>
            <div class="subsection">
                <span>C.</span>
        ...
        <div class="section">
            <p><strong>4. LEASES:</strong> Except as disclosed in this contract, Seller is not aware of any leases affecting the Property. After the Effective Date, Seller may not, without Buyer's written consent, create a new lease, amend any existing lease, or convey any interest in the Property. (Check all applicable boxes)</p>
            <div class="subsection">
                <span>☐&nbsp;A.</span>
                <div class="sub_subsection">
            ...
            <div class="subsection">
                <span>☐&nbsp;B.</span>
                <div class="sub_subsection">
                    FIXTURE LEASES: Fixtures on the Property are subject to one or more fixture leases (for example, solar panels, propane tanks, water softener, security system) and the Addendum Regarding Fixture Leases is attached to this contract.
                </div>
            </div>
            <div class="subsection">
                <span>☐&nbsp;C.</span>
                <div class="sub_subsection">
                    NATURAL RESOURCE LEASES: "Natural Resource Lease" means an existing oil and gas, mineral, geothermal, water, wind, or other natural resource lease affecting the Property to which Seller is a party.
                </div>
            </div>
            <div class="subsection">
                <span>☐&nbsp;1.</span>
